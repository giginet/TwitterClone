...
sub show_friend_timeline :Tests{
  ...
  $bird0->follow($bird2);
  is_deeply [$bird0->friend_timeline], ["もう何も恐くない", "僕と契約して魔法少女になってよ！"], "フレンドタイムラインが正しく表示できる";
  $bird2->tweet("わけがわからないよ");
  is_deeply [$bird0->friend_timeline], ["わけがわからないよ", "もう何も恐くない", "僕と契約して魔法少女になってよ！"], "フレンドタイムラインが新しい順番に表示できる";
  $bird0->follow($bird1);
  is_deeply [$bird0->friend_timeline], ["わけがわからないよ", "もう何も恐くない", "そんなの絶対おかしいよ", "僕と契約して魔法少女になってよ！"], "フレンドタイムラインが新しい順番に表示できる";
}

sub tweet : Tests{
  my $bird = Bird->new(name => "Akemi Homura");
  $bird->tweet("ほむほむ");
  is_deeply [$bird->timeline], ["ほむほむ"], "つぶやいてタイムラインが取得できるか";
